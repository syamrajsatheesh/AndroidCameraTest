...
class SimpleAndroidTests(unittest.TestCase):
    ...
    def test_login(self):
        ...
        try:
            location_access = self.driver.find_element_by_accessibility_id("Allow only while using the app").click()
        except:
            pass
        ...
        self.driver.find_element_by_xpath("//android.widget.Button[@text='VIDEO']").click()
        # y = self.driver.find_element_by_accessibility_id("Video Capture)
        # y = y.location['y']
        ...
        screen_size = self.driver.get_window_size()
        self.screen_width = screen_size['width']
        video = self.driver.find_element_by_accessibility_id("Start recording")
